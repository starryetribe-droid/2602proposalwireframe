                  ...
                  {CONTRACTS.map(c => {
                     ...
                     return (
                        <button
                           ...
                           className={`text-left p-5 rounded-2xl border transition-all ${isLapsed ? 'bg-gray-100 border-transparent opacity-60' :
            ...
            <div className="grid grid-cols-2 gap-3">
               {CLAIM_TYPES.map(type => (
                  <button
                     ...
                     className={`p-5 rounded-2xl border flex flex-col items-center justify-center text-center gap-3 transition-all h-40 ${claimType === type.id
